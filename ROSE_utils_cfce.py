...
#OPTIONAL: define the absolute path to the Annotation files; if null, then ROSE
#uses the cwd
ANNOTATION_PATH="/data/rose/annotation"

#set the annotation file path
cwd = ANNOTATION_PATH if ANNOTATION_PATH else \
    os.path.join(os.getcwd(), "annotation")
genomeDict = {
